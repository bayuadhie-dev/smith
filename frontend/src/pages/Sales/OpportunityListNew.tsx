    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center">
          <FunnelIcon className="h-8 w-8 text-gray-600 dark:text-gray-300 mr-4" />
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Opportunity Pipeline</h1>
            <p className="text-gray-600 dark:text-gray-300 mt-1">Manage and track your sales opportunities</p>
          </div>
        </div>
