    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="card p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Total Costs</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{formatRupiah(getTotalCosts())}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Units Produced</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{getTotalUnits().toLocaleString()}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Avg Cost/Unit</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{formatRupiah(getAverageCostPerUnit())}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Cost Centers</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{costAnalysis.length}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">{breakdown.materials.percentage.toFixed(1)}%</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">{breakdown.labor.percentage.toFixed(1)}%</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">{breakdown.overhead.percentage.toFixed(1)}%</p>
              </div>
            </div>
          </div>
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead className="bg-gray-50 dark:bg-gray-900">
                <tr>
                  ...
                  <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">{t('products.bom.total_cost')}</th>
                  ...
                  <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="text-sm font-medium text-gray-900 dark:text-white">{item.cost_center}</div>
                      </div>
                    </td>
      ...
      {costAnalysis.length === 0 && !loading && (
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">No cost analysis data found</h3>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Cost data will appear here once production starts</p>
        </div>
      )}
    </div>
  )
