    ...
    <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <button
                ...
                className="px-3 py-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:bg-gray-700 rounded-md"
              >
                ← Previous Week
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Active Machines</h3>
            <p className="text-2xl font-bold text-green-600">{activeMachines.length}</p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Active Shifts</h3>
            <p className="text-2xl font-bold text-purple-600">{activeShifts.length}</p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">This Week Assignments</h3>
                  ...
                  <table className="min-w-full">
                    <thead className="bg-gray-50 dark:bg-gray-900">
                      <tr>
                        ...
                        {weekDays.map((day) => (
                          <th key={day.toISOString()} className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      ...
                      {activeMachines.map((machine) => (
                        <React.Fragment key={machine.id}>
                          {(selectedShift ? activeShifts.filter(s => s.id === selectedShift) : activeShifts).map((shift) => (
                            <tr key={`${machine.id}-${shift.id}`} className="hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900">
