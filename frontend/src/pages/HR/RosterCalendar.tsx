  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Employee Roster</h1>
          <p className="text-gray-600 dark:text-gray-300">View and manage employee shift schedules</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full">
              <thead>
                <tr>
                  <th className="px-4 py-2 bg-gray-50 dark:bg-gray-900 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">
                  </th>
                  {weekDays.map((day) => (
                    <th key={day.toString()} className="px-4 py-2 bg-gray-50 dark:bg-gray-900 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">
                        ...
                        <td key={day.toString()} className="px-2 py-2 text-center">
                          {dayRoster ? (
                            dayRoster.is_off_day ? (
                              <span className="inline-block px-3 py-1 text-xs rounded-full bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300">
                              </span>
                            ) : (
