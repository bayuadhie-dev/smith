...
const AttendanceReport: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      default:
        return <span className="px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 rounded-full text-xs font-medium">{status}</span>;
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Laporan Absensi</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">Rekap kehadiran karyawan</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl border p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Hadir Hari Ini</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{dashboardStats.today.total}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Tepat Waktu</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Terlambat Hari Ini</p>
        ...
        <div className="p-4">
          ...
          {activeTab === 'daily' ? (
            <div className="flex flex-wrap gap-4 mb-4">
              ...
              <div>
                <label className="block text-sm text-gray-600 dark:text-gray-300 mb-1">Tanggal Akhir</label>
                <input
                  type="date"
                  value={endDate}
            ...
            <div className="flex gap-4 mb-4">
              <div>
                <label className="block text-sm text-gray-600 dark:text-gray-300 mb-1">Bulan</label>
                <select
                  value={selectedMonth}
              ...
              <div>
                <label className="block text-sm text-gray-600 dark:text-gray-300 mb-1">Tahun</label>
                <select
                  value={selectedYear}
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b bg-gray-50 dark:bg-gray-900">
                      ...
                      <th className="text-left py-3 px-4 font-medium text-gray-600 dark:text-gray-300">Nama</th>
                      <th className="text-left py-3 px-4 font-medium text-gray-600 dark:text-gray-300">Clock In</th>
                      <th className="text-left py-3 px-4 font-medium text-gray-600 dark:text-gray-300">Clock Out</th>
                      <th className="text-left py-3 px-4 font-medium text-gray-600 dark:text-gray-300">Jam Kerja</th>
                      <th className="text-left py-3 px-4 font-medium text-gray-600 dark:text-gray-300">Lembur</th>
                  ...
                  <tbody>
                    {records.length === 0 ? (
                      ...
                      records.map((record) => (
                        <tr key={record.id} className="border-b hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900">
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-between mt-4 pt-4 border-t">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-lg text-sm">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b bg-gray-50 dark:bg-gray-900">
                    <th className="text-left py-3 px-4 font-medium text-gray-600 dark:text-gray-300">Nama</th>
                    <th className="text-center py-3 px-4 font-medium text-gray-600 dark:text-gray-300">Total Hari</th>
                    <th className="text-center py-3 px-4 font-medium text-gray-600 dark:text-gray-300">Hadir</th>
                    <th className="text-center py-3 px-4 font-medium text-gray-600 dark:text-gray-300">Terlambat</th>
                    <th className="text-center py-3 px-4 font-medium text-gray-600 dark:text-gray-300">Total Jam Kerja</th>
                    <th className="text-center py-3 px-4 font-medium text-gray-600 dark:text-gray-300">Total Lembur</th>
                  </tr>
                </thead>
                <tbody>
