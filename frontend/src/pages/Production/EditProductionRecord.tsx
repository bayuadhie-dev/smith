...
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-07-20 13:29:35
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-07-20 13:39:53
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-07-20 13:44:08
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-07-20 13:54:56
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-07-20 14:05:25
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-07-21 11:55:45
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-07-21 14:06:46
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-07-22 16:35:37
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-08-11 10:25:37
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-08-11 10:29:02
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-08-24 14:21:36
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-08-25 09:46:59
// AUTO-GENERATED by Keyword Manager GUI - DO NOT EDIT MANUALLY
// Last synced: 2026-08-25 09:48:55
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  // IDLE: Menunggu material/resource - waktu tidak produktif bukan karena kerusakan
  idle: [
    'ambil kain', 'ambil stiker', 'box belum datang', 'box habis', 'buat carton', 'buat karton', 
    'idle', 'ingredient habis', 'kain belum datang', 'kain habis', 'karton habis', 
    'kekurangan orang', 'keranjang habis', 'label habis', 'lem habis', 'listrik padam', 
    'mc stop ( sisa kain dipakai untuk mc 6 ( wetkins antiseptic', 'menganggur', 
    'menghabiskan ingredient ( opr dialihkan ke packing manual )', 'menghabiskan order', 
    ...
    'opr dialihkan ke mc 11', 'opr jalan di mc 10', 'opr jalan di mc 7', 'opr pulang ( sakit )', 
    'packaging belum datang', 'packaging habis', 'packing habis', 
    'packing manual ( idm alcohol wipes 10s )', 'panel jumbo roll error', 'persiapan produk', 
    ...
    'tunggu box', 'tunggu checker', 'tunggu glove', 'tunggu gloves', 'tunggu hasil qc', 
    'tunggu ingredient', 'tunggu instruksi', 'tunggu kain', 'tunggu karton', 'tunggu keranjang', 
    'tunggu label', 'tunggu lem', 'tunggu material', 'tunggu mixing', 'tunggu obat', 
    'tunggu order', 'tunggu packaging', 'tunggu personil', 'tunggu produk', 'tunggu qc', 
    'tunggu sarung tangan', 'tunggu stiker', 'tunggu temperatur', 'tunggu temperature', 
    'tunggu temperature stabil', 'tunggu temperatur stabil', 'tunggu tinta', 'tunggu troli', 
  ...
  mesin: [
    ...
    'compressor', 'control panel error', 'conveyor', 'dosing', 'dossing', 'end seal', 'endseal', 
    'exhaust error', 'exouse error', 'eyemark stiker error', 'feeding', 'flange lepas', 'folding', 
    'ganti sparepart', 'guset', 'head inkjet', 'hidrolik', 'home position error', 'hydraulic', 
    'ink jet', 'ink-jet', 'inkjet', 'inkjet error', 'inkjet macet', 'jarum bengkok', 'jarum patah', 
    'kain keluar jalur', 'kain menggulung', 'kalibrasi', 'keluar jalur', 'keluar jalur (bak mesin', 
    'ke seal', 'keseal', 'lebar kain', 'lebar kain tidak maksimal', 
    'line together miring ( baut lepas )', 'lipatan', 'listrik mati', 'maintenance', 
    'mc error ( home position )', 'mc error ( tiba - tiba berhenti )', 'mc home position', 
    'mc pompa obat tanki bocor', 'mc press', 'menggulung', 'merge phase error', 
    'merge phase longgar', 'mesin error', 'mesin macet', 'mesin mati', 'mesin rusak', 
    'mesin trouble', 'motor rusak', 'needle', 'overheat', 'overheating', 'packaging kusut', 
    'packaging lepas', 'packaging panjang pendek', 'packaging putus', 'pendorong kain patah', 
    'penjepit', 'penyangga roll lepas', 'perbaikan', 'pisau', 'pneumatic', 'posisi stiker', 
    'pound', 'power failure', 'printer inkjet', 'print error ( printing buram )', 'produk bocor', 
    ...
    'simetris error', 'sparepart', 'stacker', 'stacking', 'stiker double', 'stiker error', 
    'stiker putus', 'suhu', 'tekanan angin', 'temperature', 'tension', 'terseal', 'tidak maksimal', 
    'tidak rapi', 'tidak stabil', 'timbangan error', 'tinta inkjet', 'tumpukan', 'vanbelt'
  ],
  ...
  design: [
    ...
    'pasang stiker', 'pattern salah', 'persiapan produksi', 'pola salah', 'prototype', 're-pack', 
    'repack', 're packing', 'repacking', 'revisi desain', 'revisi design', 'sample', 'sanitasi', 
    'setting dan tunggu temperatur', 'setting tunggu temperatur', 'spec salah', 
  ...
  operator: [
    ...
    'setting', 'settin mc', 'telat', 'tidak fokus'
  ],
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <p className="text-sm text-yellow-800">
          <strong>Perhatian:</strong> Mengubah data produksi akan mempengaruhi total produksi SPK. 
