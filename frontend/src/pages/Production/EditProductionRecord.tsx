...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  idle: [
    ...
    'menganggur', 'menghabiskan order', 'menhabiskan order', 'menunggu kain', 'menunggu mixing', 
  ...
  mesin: [
    ...
    'exouse error', 'eyemark stiker error', 'feeding', 'folding', 'ganti sparepart', 'guset', 
    'head inkjet', 'hidrolik', 'home position error', 'hydraulic', 'ink jet', 'ink-jet', 'inkjet', 
    'inkjet error', 'inkjet macet', 'jarum bengkok', 'jarum patah', 'kain keluar jalur', 
    'kain menggulung', 'kalibrasi', 'ke seal', 'keluar jalur', 'keluar jalur (bak mesin', 'keseal', 
    'lebar kain', 'lebar kain tidak maksimal', 'lipatan', 'listrik mati', 'maintenance', 
    ...
    'mesin trouble', 'motor rusak', 'needle', 'overheat', 'overheating', 'packaging lepas', 
    ...
    'power failure', 'print error ( printing buram )', 'printer inkjet', 'produk bocor', 'pusher', 
  ...
  design: [
    ...
    're packing', 're-pack', 'repack', 'repacking', 'revisi desain', 'revisi design', 'sample', 
