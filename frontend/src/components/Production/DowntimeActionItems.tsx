    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-slate-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-white">
                Top 3 Penyebab Target Tidak Tercapai
              </h3>
              <p className="text-sm text-white/80">
                Unplanned Downtime - Minggu {weekNumber} ({month}/{year})
              </p>
            </div>
          </div>
        ...
        <table className="w-full">
          <thead className="bg-slate-50 dark:bg-gray-900">
            <tr>
              ...
              <th className="px-4 py-3 text-center text-xs font-semibold text-slate-600 dark:text-gray-300">Aksi</th>
            </tr>
          </thead>
      ...
      <div className="bg-slate-50 dark:bg-gray-900 px-6 py-3 border-t border-slate-200 dark:border-gray-700">
        <p className="text-xs text-slate-500 dark:text-gray-400">
          💡 <strong>Catatan:</strong> Data ini dihasilkan dari top 3 unplanned downtime (mesin, operator, material) per produk. 
          Isi root cause dan follow up untuk tracking di rapat Senin.
        </p>
      </div>
    </div>
  );
