...
def get_records():
    ...
    try:
        ...
        for sp in shift_records:
            ...
            idle_keywords = [
                'ambil kain', 'box belum datang', 'box habis', 'idle', 'ingredient habis', 
                'kain belum datang', 'kain habis', 'karton habis', 'keranjang habis', 
                'label habis', 'lem habis', 'menganggur', 'menghabiskan order', 
                ...
                'nunggu packaging', 'nunggu stiker', 'nunggu tinta', 'obat belum datang', 
                'obat habis', 'packaging belum datang', 'packaging habis', 'packing habis', 
                'persiapan produk', 'siapkan produk', 'standby', 'stiker belum datang', 
                'stiker habis', 'susun produk', 'tidak ada order', 'tinta habis', 'troli habis', 
                'trolley habis', 'tunggu approval', 'tunggu bahan', 'tunggu bahan kimia', 
                'tunggu box', 'tunggu glove', 'tunggu gloves', 'tunggu hasil qc', 
                'tunggu ingredient', 'tunggu instruksi', 'tunggu kain', 'tunggu karton', 
                'tunggu keranjang', 'tunggu label', 'tunggu lem', 'tunggu material', 
                'tunggu mixing', 'tunggu obat', 'tunggu order', 'tunggu packaging', 
                'tunggu produk', 'tunggu qc', 'tunggu sarung tangan', 'tunggu stiker', 
                'tunggu temperatur', 'tunggu temperatur stabil', 'tunggu temperature', 
                'tunggu temperature stabil', 'tunggu tinta', 'tunggu troli', 'tunggu trolley', 
                'waiting for'
            ]
...
def get_daily_controller():
    ...
    try:
        ...
        idle_keywords = [
            'ambil kain', 'box belum datang', 'box habis', 'idle', 'ingredient habis', 
            'kain belum datang', 'kain habis', 'karton habis', 'keranjang habis', 'label habis', 
            'lem habis', 'menganggur', 'menghabiskan order', 'menhabiskan order', 'menunggu kain', 
            ...
            'obat belum datang', 'obat habis', 'packaging belum datang', 'packaging habis', 
            'packing habis', 'persiapan produk', 'siapkan produk', 'standby', 
