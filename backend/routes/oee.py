    ...
    try:
        ...
        for sp in shift_records:
            ...
            idle_keywords = [
                ...
                'packing habis', 'packing manual ( idm alcohol wipes 10s )', 
                'panel jumbo roll error', 'persiapan produk', 
                ...
                'tunggu bahan kimia', 'tunggu box', 'tunggu checker', 'tunggu glove', 
                'tunggu gloves', 'tunggu hasil qc', 'tunggu ingredient', 'tunggu instruksi', 
                'tunggu kain', 'tunggu karton', 'tunggu keranjang', 'tunggu label', 'tunggu lem', 
                'tunggu material', 'tunggu mixing', 'tunggu obat', 'tunggu order', 
                'tunggu packaging', 'tunggu personil', 'tunggu produk', 'tunggu qc', 
                'tunggu sarung tangan', 'tunggu stiker', 'tunggu temperatur', 'tunggu temperature', 
                'tunggu temperature stabil', 'tunggu temperatur stabil', 'tunggu tinta', 
                'tunggu troli', 'tunggu trolley', 'waiting for'
            ]
...
def get_daily_controller():
    ...
    try:
        ...
        idle_keywords = [
            ...
            'packing manual ( idm alcohol wipes 10s )', 'panel jumbo roll error', 
            'persiapan produk', 'produk habis ( opr dialihkan ke packing manual )', 
            ...
            'tunggu bahan', 'tunggu bahan kimia', 'tunggu box', 'tunggu checker', 'tunggu glove', 
            'tunggu gloves', 'tunggu hasil qc', 'tunggu ingredient', 'tunggu instruksi', 
            'tunggu kain', 'tunggu karton', 'tunggu keranjang', 'tunggu label', 'tunggu lem', 
            'tunggu material', 'tunggu mixing', 'tunggu obat', 'tunggu order', 'tunggu packaging', 
            'tunggu personil', 'tunggu produk', 'tunggu qc', 'tunggu sarung tangan', 
            'tunggu stiker', 'tunggu temperatur', 'tunggu temperature', 
            'tunggu temperature stabil', 'tunggu temperatur stabil', 'tunggu tinta', 
            'tunggu troli', 'tunggu trolley', 'waiting for'
        ]
