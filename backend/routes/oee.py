    ...
    try:
        ...
        for sp in shift_records:
            ...
            idle_keywords = [
                ...
                'listrik padam', 'menganggur', 'menghabiskan order', 'menhabiskan order', 
                'menunggu kain', 'menunggu mixing', 'menunggu obat', 'menunggu packaging', 
                'menunggu stiker', 'menunggu tinta', 'menyiapkan produk', 'mixing belum siap', 
                'no order', 'nunggu kain', 'nunggu mixing', 'nunggu obat', 'nunggu packaging', 
                'nunggu stiker', 'nunggu tinta', 'obat belum datang', 'obat habis', 
                'operator dialihkan ke mc 7', 'opr dialihkan ke mc 11', 'opr jalan di mc 10', 
                'opr jalan di mc 7', 'packaging belum datang', 'packaging habis', 'packing habis', 
                'packing manual ( idm alcohol wipes 10s )', 'persiapan produk', 
