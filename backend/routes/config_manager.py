...
MASTER_CONFIGS = [
    ...
    {'key': 'notifications.whatsapp_provider',    'category': 'notifications', 'name': 'WhatsApp Provider',           'value': 'local', 'type': 'string', 'description': 'Penyedia layanan WhatsApp: local (self-hosted Node.js gateway) atau twilio (WhatsApp Business API).'},
    {'key': 'notifications.whatsapp_api_url',     'category': 'notifications', 'name': 'WhatsApp API Gateway URL',    'value': 'http://localhost:8000/send-message', 'type': 'string', 'description': 'URL API Gateway untuk mengirimkan pesan WhatsApp (jika menggunakan provider local).'},
    {'key': 'notifications.whatsapp_token',       'category': 'notifications', 'name': 'WhatsApp API Secret Token',  'value': 'local-wa-secret-token', 'type': 'string', 'description': 'Token rahasia (X-API-Key) untuk mencocokkan request dari backend ke WA Gateway (jika menggunakan provider local).'},
    {'key': 'notifications.twilio_account_sid',   'category': 'notifications', 'name': 'Twilio Account SID',          'value': 'ACxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', 'type': 'string', 'description': 'Account SID dari dashboard Twilio Anda.'},
    {'key': 'notifications.twilio_auth_token',    'category': 'notifications', 'name': 'Twilio Auth Token',           'value': 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', 'type': 'string', 'description': 'Auth Token dari dashboard Twilio Anda.'},
    {'key': 'notifications.twilio_from_number',   'category': 'notifications', 'name': 'Twilio From WhatsApp Number', 'value': '+14155238886', 'type': 'string', 'description': 'Nomor WhatsApp pengirim dari Twilio (e.g. nomor sandbox +14155238886).'},
