...
def detect_downtime_category(issue_text: str, is_first_entry: bool = False) -> str:
    ...
    idle_keywords = [
        ...
        'listrik padam', 'menganggur', 'menghabiskan order', 'menhabiskan order', 'menunggu kain', 
        ...
        'obat belum datang', 'obat habis', 'operator dialihkan ke mc 7', 'opr dialihkan ke mc 11', 
        'opr jalan di mc 10', 'opr jalan di mc 7', 'packaging belum datang', 'packaging habis', 
        'packing habis', 'packing manual ( idm alcohol wipes 10s )', 'persiapan produk', 
    ...
    mesin_keywords = [
        ...
        'endseal', 'exhaust error', 'exouse error', 'eyemark stiker error', 'feeding', 'folding', 
        'ganti sparepart', 'guset', 'head inkjet', 'hidrolik', 'home position error', 'hydraulic', 
        'ink jet', 'ink-jet', 'inkjet', 'inkjet error', 'inkjet macet', 'jarum bengkok', 
        'jarum patah', 'kain keluar jalur', 'kain menggulung', 'kalibrasi', 'ke seal', 
        'keluar jalur', 'keluar jalur (bak mesin', 'keseal', 'lebar kain', 
        ...
        'power failure', 'print error ( printing buram )', 'printer inkjet', 'produk bocor', 
