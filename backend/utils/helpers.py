...
def detect_downtime_category(issue_text: str, is_first_entry: bool = False) -> str:
    ...
    mesin_keywords = [
        ...
        'guset', 'head inkjet', 'hidrolik', 'hydraulic', 'ink jet', 'ink-jet', 'inkjet', 
        'inkjet error', 'inkjet macet', 'jarum bengkok', 'jarum patah', 'kain keluar jalur', 
        'kain menggulung', 'kalibrasi', 'ke seal', 'keluar jalur', 'keluar jalur (bak mesin', 
        'keseal', 'lebar kain', 'lebar kain tidak maksimal', 'lipatan', 'listrik mati', 
        'maintenance', 'mc pompa obat tanki bocor', 'mc press', 'menggulung', 'merge phase error', 
        'mesin error', 'mesin macet', 'mesin mati', 'mesin rusak', 'mesin trouble', 'motor rusak', 
        'needle', 'overheat', 'overheating', 'packaging panjang pendek', 'packaging putus', 
        'pendorong kain patah', 'penjepit', 'perbaikan', 'pisau', 'pneumatic', 'posisi stiker', 
        'pound', 'power failure', 'print error ( printing buram )', 'printer inkjet', 
        'produk bocor', 'pusher', 'rantai lepas', 'relay', 'seal bawah', 'seal bocor', 
        ...
        'stacking', 'stiker double', 'stiker putus', 'suhu', 'tekanan angin', 'temperature', 
        'tension', 'terseal', 'tidak maksimal', 'tidak rapi', 'tidak stabil', 'timbangan error', 
        'tinta inkjet', 'tumpukan', 'vanbelt'
    ]
