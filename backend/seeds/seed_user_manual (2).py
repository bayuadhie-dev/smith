"""
Seed data for User Manual (Alternative version)
"""
import sys
import os
...
def seed_manual():
    ...
    articles = [
        ...
        (1, 1, 'Pengenalan Sistem ERP', 'pengenalan-sistem-erp', 
         f'Pengenalan dasar tentang sistem ERP {COMPANY_NAME}',
         f'''# Pengenalan Sistem ERP
...
Sistem ERP {COMPANY_NAME} terdiri dari beberapa modul utama:
