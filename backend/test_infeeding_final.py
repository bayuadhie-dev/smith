...
with app.app_context():
    ...
    try:
        ...
        for reason in test_reasons:
            ...
            result = 'MESIN ✅' if is_machine else 'NOT MESIN ❌'
        ...
        for reason in test_reasons:
            ...
            result = 'MESIN ✅' if is_frontend_mesin else 'NOT MESIN ❌'
            print(f"  Frontend '{reason}' -> {result}")
        
        print(f"\n🎉 SUMMARY:")
        print(f"✅ Backend: 'infeeding macet' keywords added to machine_keywords")
        print(f"✅ Frontend: 'infeeding macet' keywords added to CATEGORY_KEYWORDS.mesin")
        print(f"✅ Both frontend and backend will categorize 'infeeding macet' as MESIN downtime")
