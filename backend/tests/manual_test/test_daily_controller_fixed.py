...
with app.app_context():
    ...
    try:
        ...
        for row in result:
            ...
            speed = int(row[2]) if row[2] else 0
            ...
            print(f"  Shift {shift_num}: grade_a={grade_a}, downtime={downtime}, idle={idle}, speed={speed}")
        ...
        # Apply the new logic (user input = 0)
        user_waktu_tidak_tercatat = 0  # Since user input 0 for both shifts
